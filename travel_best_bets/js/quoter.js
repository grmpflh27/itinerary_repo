...
function updateDates(){
	var src_obj = document.getElementById("ddate".format(flight_counter));
 	src_obj.onchange = function(){
 		dst_obj = document.getElementById("adate".format(flight_counter));
		dst_obj.value = src_obj.value;
		ret_dep_obj = document.getElementById("rddate".format(flight_counter));
		NO_OF_NIGHTS = document.getElementById("nights").value;
		var tmp = moment(dst_obj.value)
		tmp = tmp.add(NO_OF_NIGHTS, 'days')
		ret_dep_obj.value = tmp.format("YYYY-MM-DD")
		ret_arr_obj = document.getElementById("radate".format(flight_counter));
...
function getFlightHTML(){
    ...
    <legend>Flight</legend>
		<table border=0 id="flight_{0}">
			...
			<tr>
				<td>Departure date:</td>
				<td><input type="date" id="rddate" value={1}></td>
			</tr>
			<tr>
				<td>Departure time:</td>
			...
			<tr>
				<td>Arrival date:</td>
				<td><input type="date" id="radate" value={1}></td>
			</tr>
			<tr>
				<td>Arrival time:</td>
	...
	`.format(flight_counter, moment().format("YYYY-MM-DD"), "12:00")
